...
<!-- Sidebar End -->
		...
		<div class="col-md-9"> <!--col-md-9 Start-->
			<div class="row" id="nutralrdmain"> <!--Row Start-->
				<div class="col-sm-6"> <!--col-sm-6 Start-->
					<div id="nutralrdimage"> <!--nutralrdimage Start-->
						<center>
							<img src="admin_area/product_images/Nutral-RD.jpg" class="img-responsive">
						</center>
						...
						<div class="box"> <!--Box Start-->
							<form action="nutralrd.php" method="post" class="form-horizontal">
								...
								<div class="dropdown"> <!--dropdown Start-->
									<button class="dropbtn">Tap To View Contains In Nutral-RD</button>
									<div class="dropdown-viewcontains"> <!--dropdown-viewcontain Start-->
										<a href="#">1. Rabeprazole 20 mg.</a>
										<a href="#">2. Domperidone 30 mg.</a>
								...
								<div class="form-group"> <!--form-group Start-->
									<div class="col-md-7"> <!--col-md-7 Start-->
								<div class="dropdown"> <!--dropdown Start-->
									<button class="dropbtn">Tap To View Uses of Nutral-RD</button>
									<div class="dropdown-viewuses"> <!--dropdown-viewuses Start-->
										<a href="#">1. Treatment Of Gastroesophageal reflux disease (Acid Reflux).</a>
										<a href="#">2. Treatment Of Peptic ulcer disease.</a>
								...
								<div class="form-group"> <!--form-group Start-->
									<div class="col-md-7"> <!--col-md-7 Start-->
								<div class="dropdown"> <!--dropdown Start-->
									<button class="dropbtn">Tap To View Side Effects Of Nutral-RD</button>

...
<div id="visionmain"><!--vision Start-->
	<div class="container"> <!--container Start-->
		<div class="col-md-12"> <!--col-md-12 Start-->
			<div class="box same-height"> <!--box same-height Start-->
				<center>
					<h4>1. Our vision is to make "TRUST Means AAGNEY PHARMACEUTICALS LLP" true.</h4>
					<h4>2. Vision of AAGNEY PHARMACEUTICALS LLP is to serve humanity with affordable health solution. </h4>
				</center> 
...
<div id="missionmain"><!--vision Start-->
	<div class="container"> <!--container Start-->
		<div class="col-md-12"> <!--col-md-12 Start-->
			<div class="box same-height"> <!--box same-height Start-->
				<center>
					<h4>1. Mission is to server best quality products to suffering humanity at affordable price.</h4>
					<h4>2. Build so much trust in billions of peoples with serving a high quality products at affordable price.</h4>
				</center> 
			</div> <!--box same-height End-->
		</div> <!--col-md-12 End--> 
	</div> <!--Container End-->
